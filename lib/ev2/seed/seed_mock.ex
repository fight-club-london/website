defmodule Mix.Tasks.Ev2.SeedMock do

  @moduledoc """
    This file handles seeding mock data.
    It is a mix task so can be run from terminal with `$ mix Ev2.SeedMock`
  ...
  """
  def seed_mock do
    is_dev? = Application.get_env(:ev2, :env) == :dev
    is_staging? = Application.get_env(:ev2, :IS_STAGING)
